...
public class SignaturePad extends View {
    ...
    public Bitmap mSignatureBitmap = null;
    private Canvas mSignatureBitmapCanvas = null;
    public ArrayList<Float> mListX = null;//x点坐标
    public ArrayList<Float> mListY = null;//y点坐标

    public  static List<ArrayList<Float>> mListAllX = null;
    public  static List<ArrayList<Float>> mListAllY = null;
    private int i = 0;

    public SignaturePad(Context context, AttributeSet attrs) {
        super(context, attrs);
        mListAllX = new ArrayList<>();
        mListAllY = new ArrayList<>();
        ...
        try {
            ...
            mVelocityFilterWeight = a.getFloat(R.styleable.SignaturePad_velocityFilterWeight, 0.3f);
...
//                Log.v("DOWN: ","eventX-"+eventX+" eventY-"+eventY);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                addPoint(new TimedPoint(eventX, eventY));
//                Log.v("MOVE: ", "eventX-" + eventX + " eventY-" + eventY);
                break;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mListX.size() > 1) {
                    mListAllX.add(mListX);
                    mListAllY.add(mListY);
                    setIsEmpty(false);
                }
