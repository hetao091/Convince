...
class RenderingAsyncTask extends AsyncTask<Void, PagePart, Void> {
    ...
    public RenderingAsyncTask(PDFView pdfView, AgileCore agileCore, PdfDocument pdfDocument) {
        this.pdfView = pdfView;
        this.mAgileCore = agileCore;
    ...
    private PagePart proceed(RenderingTask renderingTask) {
        if (!openedPages.contains(renderingTask.page)) {
            ...
            mAgileCore.openPage(pdfDocument, renderingTask.page);
        }
        ...
        if (!isCancelled()) {
            mAgileCore.renderPageBitmap(pdfDocument, render, renderingTask.page,
